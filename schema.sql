-- EduSphere AI LMS Database Schema and Seed Data
...
CREATE TABLE questions (
    ...
    options JSON NOT NULL, -- JSON list of strings, e.g. ["Option A", "Option B"]
...
-- Hash: $2a$10$H8z2QpQZ/Kq2hT9f8r0pBe6y9i8D86s3vW5.mJ80LgZt62UexfS4u
